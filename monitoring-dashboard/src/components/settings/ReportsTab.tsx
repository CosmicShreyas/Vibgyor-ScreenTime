...
const ReportsTab: React.FC = () => {
  ...
  const eodPagination = usePagination(eodConfigs, 10);
                  ...
                  ...(
                    Array.isArray(connectedClients)
                      ? connectedClients.map((client) => ({
                          ...
                          label: `${client.employeeName || 'Unknown'} (${client.clientId})`,
                        }))
                      : []
                  ),
                ]}
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-lg">
          ...
          {eodConfigs.length > 0 ? (
            <div className="space-y-3">
              {eodPagination.pageItems.map((eodConfig) => (
                <div
                  key={eodConfig._id}
              ...
              <Pagination
                page={eodPagination.page}
                pageSize={eodPagination.pageSize}
                totalItems={eodConfigs.length}
                onPageChange={eodPagination.setPage}
                onPageSizeChange={eodPagination.setPageSize}
                itemLabel="reports"
              />
            </div>
          ) : (
