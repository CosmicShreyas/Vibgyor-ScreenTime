...
export function StatTile({
  ...
  return (
    <MotionCard accent className="group overflow-hidden p-5">
  ...
  return (
    <div className="app-page">
      <motion.header
        ...
        style={{
          background:
            'radial-gradient(120% 140% at 0% 0%, color-mix(in oklab, var(--primary) 14%, transparent), transparent 55%), radial-gradient(120% 140% at 100% 0%, color-mix(in oklab, var(--signal) 12%, transparent), transparent 60%), var(--card)',
        }}
      >
      ...
      <Stagger className="space-y-5">{children}</Stagger>
    </div>
  )
}
