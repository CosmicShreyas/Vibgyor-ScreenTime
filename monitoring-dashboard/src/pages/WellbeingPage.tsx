...
import { getTodayLocalDate, addDaysStr, daysBetweenStr, formatMinutes } from '../utils/time'
...
export default function WellbeingPage() {
  ...
  return (
    <PageShell
      ...
      description="See how well your team stays focused, who may be at risk of burnout, and any unusual work patterns. Use these insights to support healthier workloads while respecting employee privacy."
      icon={HeartPulse}
      actions={
            ...
            {focus ? (
              <>
                <div className="mb-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
                  ...
                  <MiniStat
                    label="Avg focus / day"
                    value={formatMinutes(focus.avg_focus_minutes)}
                    modalTone="primary"
                  ...
                  <MiniStat
                    ...
                    value={formatMinutes(focus.best_focus_minutes)}
