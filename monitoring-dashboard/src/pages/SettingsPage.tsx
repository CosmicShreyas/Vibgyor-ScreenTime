...
import { Monitor, Server, Layout, Mail, Users, SlidersHorizontal, BellRing, Activity } from 'lucide-react';
...
import ServerStatisticsTab from '../components/settings/ServerStatisticsTab';
import OTPModal from '../components/OTPModal';
import { PageShell, MotionCard } from '../components/ui';
import { riseItem } from '../components/ui/motion';

type TabType = 'client' | 'server' | 'server-statistics' | 'dashboard' | 'reports' | 'alerts' | 'connected-clients';
...
const SettingsPage: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'server-statistics' as TabType, label: 'Server Statistics', icon: Activity },
  ...
  return (
    <div className="settings-shadowless">
    <PageShell
    ...
    >
      ...
      <MotionCard hover={false} className="overflow-hidden p-5">
        ...
        >
          ...
          {activeTab === 'server-statistics' && <ServerStatisticsTab />}
