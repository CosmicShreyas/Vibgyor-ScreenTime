        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <!-- AI Insights -->
              <div style="margin-top: 20px; padding: 20px; background-color: #f5f3ff; border: 1px solid #ddd6fe; border-radius: 8px;">
                <p style="margin: 0 0 10px 0; font-size: 15px; font-weight: 700; color: #6d28d9;">💡 Key Insights</p>
                <ul style="margin: 0; padding-left: 18px; color: #4c1d95; font-size: 14px; line-height: 1.6;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 30px 30px 20px 30px;">
              ...
              <div style="margin-top: 16px; padding: 14px 16px; background-color: #f5f3ff; border-left: 4px solid #7c3aed; border-radius: 6px;">
                <p style="margin: 0; font-size: 14px; color: #4c1d95;">💡 ${eodInsight}</p>
              </div>
            </td>
          </tr>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Client Offline Alert</title>
</head>
<body style="margin:0;padding:0;background-color:#eef2ff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:32px 16px;background:linear-gradient(180deg,#eef2ff 0%,#f8fafc 100%);">
    <tr>
      <td align="center">
        <table width="640" cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;background-color:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 18px 50px rgba(15,23,42,0.14);">
          <tr>
            <td style="padding:36px 32px;background:linear-gradient(135deg,#2563eb 0%,#7c3aed 100%);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    <div style="display:inline-block;padding:6px 12px;border-radius:999px;background:rgba(255,255,255,0.16);color:#e0e7ff;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;">
                      Screentime Monitoring
                    </div>
                    <h1 style="margin:16px 0 8px 0;color:#ffffff;font-size:30px;line-height:1.2;font-weight:800;">Client Offline Alert</h1>
                    <p style="margin:0;color:#dbeafe;font-size:15px;line-height:1.6;">
                      A monitored client has stopped checking in and has now crossed the offline threshold.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:32px;">
              <div style="padding:18px 20px;border-radius:18px;background:linear-gradient(135deg,#fff1f2 0%,#f8fafc 100%);border:1px solid #fecdd3;">
                <p style="margin:0 0 6px 0;color:#be123c;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;">Status</p>
                <p style="margin:0;color:#0f172a;font-size:24px;font-weight:800;">${escapeHtml(data.employeeName)} is offline</p>
                <p style="margin:10px 0 0 0;color:#475569;font-size:14px;line-height:1.6;">
                  Last check-in was at ${formatDateTime(data.offlineSince)}. Alert generated at ${formatDateTime(data.detectedAt)}.
                </p>
              </div>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:20px;">
                <tr>
                  <td width="50%" style="padding:0 8px 0 0;">
                    <div style="padding:18px;border-radius:18px;background-color:#f8fafc;border:1px solid #e2e8f0;">
                      <p style="margin:0 0 6px 0;color:#64748b;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;">Offline Duration</p>
                      <p style="margin:0;color:#0f172a;font-size:28px;font-weight:800;">${offlineMinutes} min</p>
                    </div>
                  </td>
                  <td width="50%" style="padding:0 0 0 8px;">
                    <div style="padding:18px;border-radius:18px;background-color:#f8fafc;border:1px solid #e2e8f0;">
                      <p style="margin:0 0 6px 0;color:#64748b;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;">Client ID</p>
                      <p style="margin:0;color:#0f172a;font-size:16px;font-weight:700;word-break:break-word;">${escapeHtml(data.clientId)}</p>
                    </div>
                  </td>
                </tr>
              </table>

              <div style="margin-top:20px;padding:24px;border-radius:20px;background-color:#ffffff;border:1px solid #e2e8f0;">
                <p style="margin:0 0 16px 0;color:#0f172a;font-size:18px;font-weight:700;">Client Details</p>
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                  <tr>
                    <td style="padding:10px 0;color:#64748b;font-size:13px;border-bottom:1px solid #e2e8f0;">Employee</td>
                    <td style="padding:10px 0;color:#0f172a;font-size:14px;font-weight:600;text-align:right;border-bottom:1px solid #e2e8f0;">${escapeHtml(data.employeeName)}</td>
                  </tr>
                  <tr>
                    <td style="padding:10px 0;color:#64748b;font-size:13px;border-bottom:1px solid #e2e8f0;">Employee ID</td>
                    <td style="padding:10px 0;color:#0f172a;font-size:14px;font-weight:600;text-align:right;border-bottom:1px solid #e2e8f0;">${escapeHtml(data.employeeId || 'Not available')}</td>
                  </tr>
                  <tr>
                    <td style="padding:10px 0;color:#64748b;font-size:13px;border-bottom:1px solid #e2e8f0;">Hostname</td>
                    <td style="padding:10px 0;color:#0f172a;font-size:14px;font-weight:600;text-align:right;border-bottom:1px solid #e2e8f0;">${escapeHtml(data.hostname || 'Not available')}</td>
                  </tr>
                  <tr>
                    <td style="padding:10px 0;color:#64748b;font-size:13px;">Operating System</td>
                    <td style="padding:10px 0;color:#0f172a;font-size:14px;font-weight:600;text-align:right;">${escapeHtml([data.osName, data.osVersion].filter(Boolean).join(' ') || 'Not available')}</td>
                  </tr>
                </table>
              </div>
            </td>
          ...
          <tr>
            <td style="padding:24px 32px;background-color:#f8fafc;border-top:1px solid #e2e8f0;text-align:center;">
              <p style="margin:0;color:#475569;font-size:13px;line-height:1.6;">
                This alert was generated automatically by the Screentime dashboard notification system.
              </p>
            </td>
          </tr>
        </table>
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
      <p style="margin: 0; color: #9ca3af; font-size: 12px; text-align: center;">
        Sent on ${new Date().toLocaleString('en-US', { timeZone: TZ })}
      </p>
    </div>
  </div>
</body>
