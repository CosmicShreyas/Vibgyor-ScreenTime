...
export class ServerConfigService {
  ...
  private applyToRuntime(value: ServerConfig): void {
    ...
    // The DB may hold a relative value (e.g. bootstrapped from the './screenshots'
    // default). Normalize to absolute so stored file paths work with res.sendFile.
    runtimeConfig.screenshotStoragePath = path.resolve(value.SCREENSHOT_STORAGE_PATH);
