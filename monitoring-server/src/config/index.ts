...
export const config: Config = {
  ...
  // Resolve to an absolute path up front: relative values like './screenshots'
  // would otherwise be persisted to MongoDB and later rejected by res.sendFile,
  // which requires an absolute path (or an explicit root option).
  screenshotStoragePath: path.resolve(getEnvVar('SCREENSHOT_STORAGE_PATH', './screenshots')),
