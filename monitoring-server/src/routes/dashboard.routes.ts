...
router.get('/timeline/all', async (req, res) => {
  try {
    ...
    const timeline = startDate
      ? await employeeService.getEmployeesTimelineRange(startDate as string, (endDate || startDate) as string)
      : await employeeService.getEmployeesTimeline(date as string);
